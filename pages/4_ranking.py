...
tier_info = {
    "SS": ("👑", "#ffd700", "最愛の口弱点。キスだけでとろけちゃうのね"),
    "S":  ("🔥", "#ff4081", "すごく敏感。フェラでかわいいくらい弱いわ"),
    "A":  ("💋", "#ff80ab", "かなり危険。亀頭キス集中されると負けちゃうのね"),
    "B":  ("🌸", "#ce93d8", "じわじわ口で効いてくる弱点"),
    "C":  ("💜", "#b39ddb", "まだ粘れる……でも咥えられたら負けるわ"),
    "D":  ("🖤", "#888",    "未開拓。口弱点、これから一緒に育てましょ"),
}
